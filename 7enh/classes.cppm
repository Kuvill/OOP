...
export template<>
Base* BuildTypeFactory<Interface1, Debug>( void* ) {
    return new Wrapper<Class11>;
}

export template<>
Base* BuildTypeFactory<Interface1, Release>( void* ) {
    return new Wrapper<Class12>;
}

export template<>
Base* BuildTypeFactory<Interface2, Debug>( void* ) {
    return new Wrapper<Class21>;
}

export template<>
Base* BuildTypeFactory<Interface2, Release>( void* ) {
    return new Wrapper<Class22>;
}

export template<>
Base* BuildTypeFactory<Interface3, Debug>( void* ) {
    return new Wrapper<Class31>;
}

export template<>
Base* BuildTypeFactory<Interface3, Release>( void* ) {
